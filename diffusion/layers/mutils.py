...
def get_norm_layer(norm_type='instance'):
    ...
    if norm_type == 'batch':
        ...
        from conditional_batchnorm2d import ConditionalBatchNorm2d
        norm_layer = ConditionalBatchNorm2d
    elif norm_type == "cond_instance":
        from conditional_instancenorm2d import ConditionalInstanceNorm2d
        norm_layer = ConditionalInstanceNorm2d
    elif norm_type == "cond_instance++":
        from conditional_instancenorm2d_plus import ConditionalInstanceNorm2dPlus
